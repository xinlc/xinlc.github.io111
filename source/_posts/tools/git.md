...
# --global 对登录用户所有仓库有效，对应 ~/.gitconfig 文件
# --system 对系统所有用户有效，不建议使用
...
文件在 `.git/objects/`，`hash` 值前两位是文件夹名，比如想找一个commit id 为 `f9a279f39e872a7e86048b50ec7ae43a32a57c96` 的存储位置，文件夹名 `f9` + `a279f39e872a7e86048b50ec7ae43a32a57c96`
