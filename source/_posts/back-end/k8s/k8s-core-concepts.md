...
![Kubernetes教程：Kubernetes核心概念-集群](/images/k8s/k8s-core-concepts/d7ce07842371eab180725bab5164ec17.png)
...
![Kubernetes教程：Kubernetes核心概念-Replication Controller](/images/k8s/k8s-core-concepts/03d07039d9fc80c0f692d6176f65936e.gif)
...
*如果Pods是短暂的，那么重启时IP地址可能会改变，怎么才能从前端容器正确可靠地指向后台容器呢？*[Service](https://kubernetes.io/docs/concepts/services-networking/service/) **抽象** 现在，假定有2个后台Pod，并且定义后台Service的名称为‘backend-service’，label选择器为(tier=backend, app=myapp) 的Service会完成如下两件重要的事情：
...
![Kubernetes教程：Kubernetes核心概念-Service](/images/k8s/k8s-core-concepts/e7a273fcdc03d2417b354b60c253552f.gif)
